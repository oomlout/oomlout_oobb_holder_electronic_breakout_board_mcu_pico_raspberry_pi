			...
			rotate(a = [180, 0, 0]) {
				difference() {
					union() {
						...
						translate(v = [0, -11.2500000000, 3]) {
							hull() {
								translate(v = [-2.0000000000, 20.7500000000, 0]) {
									cylinder(h = 6, r = 5);
								}
								translate(v = [2.0000000000, 20.7500000000, 0]) {
									cylinder(h = 6, r = 5);
					...
					union() {
						...
						translate(v = [-10.7500000000, -20.2500000000, 2]) {
							cube(size = [21.5000000000, 51.5000000000, 1]);
						}
						#translate(v = [-6.5000000000, -11.7500000000, 3]) {
							cube(size = [13, 11, 2]);
						}
						#translate(v = [-7.5000000000, -20.2500000000, 3]) {
							cube(size = [15, 36, 1]);
						}
						translate(v = [7.1400000000, -20.2500000000, 0]) {
							cube(size = [3.5000000000, 51.5000000000, 3]);
						}
						translate(v = [-10.6400000000, -20.2500000000, 0]) {
							cube(size = [3.5000000000, 51.5000000000, 3]);
						}
						#translate(v = [-5.5000000000, 31.0000000000, 0]) {
							cube(size = [11, 9, 3]);
						}
					}
				}
